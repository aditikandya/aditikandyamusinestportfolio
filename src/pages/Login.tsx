...
import { Mail, Lock, Eye, EyeOff, Music, ArrowRight } from 'lucide-react';
          ...
          <div className="mt-8">
            <div className="relative">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-2 bg-gradient-hero text-muted-foreground">Or continue with</span>
              </div>
            </div>
